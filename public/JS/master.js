...
var  initializeSalesForm = function () {
    ...
    enforceNumericInput('montoTotalHospedaje', true); // Permitir decimales
    enforceNumericInput('cantidadClienteHospedado', false); // Solo enteros
    enforceNumericInput('totalVentaOtroIngreso', true); // Permitir decimales
    // -------------------------------------------------------------
