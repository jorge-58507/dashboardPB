                ...
                <div class="p-6 text-gray-900">
                    ...
                    <nav class="mb-8 flex flex-wrap gap-4 justify-center">
                        ...
                        @hasanyrole('Mantenimiento|Admin') {{-- Visible para Mantenimiento y Admin --}}
                            <button class="form-button bg-accent-blue hover:bg-dark-navy text-white font-bold py-2 px-4 rounded"
                        ...
                        @hasanyrole('Mantenimiento|Admin') {{-- Ajusta los roles según quién deba ver este listado --}}
                            <button class="form-button bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
                        ...
                        @hasanyrole('Ventas|Admin') {{-- Visible para Ventas y Admin --}}
                            <button class="form-button bg-accent-blue hover:bg-dark-navy text-white font-bold py-2 px-4 rounded"
                                    data-form-url="{{ route('formulario.sales_partial') }}"> {{-- Esta ruta la crearemos luego --}}
                                Ventas
                            </button>
                        @endhasanyrole
