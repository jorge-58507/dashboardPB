...
<form id="salesForm" action="{{ route('formulario.sales.submit') }}" onsubmit="disableButton(this);" method="POST" class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md border border-light-gray" autocomplete="off">
    @csrf
