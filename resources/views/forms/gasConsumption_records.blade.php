...
<div class="bg-white p-6 rounded-lg shadow-lg">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-dark-navy">Registros de Consumo de Gas</h2>
        <form id="gas-filter-form" action="{{ route('formulario.gasConsumption.records') }}" method="GET">
